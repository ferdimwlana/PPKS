{{-- <x-app>
    <div class="card">
        ...
        <div class="card-body">
            <form method="post" action="{{url ('admin/pelaku/edit', $pelaku->id) }}">
                @csrf
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_lengkap_pelaku" value="{{ $pelaku->pelaku }}" class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="" class="control-label">No handphone Pelaku</label>
                            <input type="varchar" name="no_handphone_pelaku" value="{{ $pelaku->pelaku }}" class="form-control">
                        </div>
                    </div>
                </div>
                <div class="row">
